...
export default class Pendingbooking extends Component {
    ...
    componentDidMount() {
        document.title = 'Pending Booking : Admin Dashboard - Crowd';
        document.getElementById("global-loader").style.display = "block";
        setTimeout(() => {
            document.getElementById("global-loader").style.display = "none";
        }, 500)
        get('/booking/adminBooking/1')
            .then(res => {
                var tdata = res.data.filter(e => e.bookingDetails.orderStatus == 1 || e.bookingDetails.orderStatus == 2 || e.bookingDetails.orderStatus == 3)
    ...
    bookingShow = () => {
        return this.state.tableData.map((obj, i) => {
            if (obj.bookingDetails.orderStatus == 1 || obj.bookingDetails.orderStatus == 2 || obj.bookingDetails.orderStatus == 3) {
                return (
        ...
        return (
            <div>
                <div className="page-header mt-0 p-3">
                    <h3 className="mb-sm-0">Pending Booking</h3>
