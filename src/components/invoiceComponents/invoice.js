                            ...
                            <div className="card-body" ref={el => (this.componentRef = el)}>
                                <div className="">
                                    ...
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <td style={{ width: "25%" }}><b style={{ fontSize: "25px" }}>Tax Invoice</b></td>
                                                <td style={{ width: "20%" }}>
                                                    Order id: <b>{this.state.bookingArray.orderID}</b><br />
                                            Order Date: {this.state.bookingArray.orderDate}
                                                </td>
                                                <td style={{ width: "20%" }}>
                                                    Invoice Number: <b>{this.state.bookingArray.invoiceNumber}</b><br />
                                            Invoice Date: {this.state.bookingArray.invoiceDate}
                                                </td>

                                                <td style={{ width: "15%" }}>

                                                    GSTIN: 19AGLPH9476L1ZH<br />
                                                    {/* PAN: */}
                                                </td>
                                            </tr>
                                        </tbody>
                                            ...
                                            <div class="" >
                                                <table class="table">
                                                    <tbody>
                                                        ...
                                                        {String(this.state.shippingAddress.flat).length > 2 && this.state.shippingAddress.flat != null ? <><br/>{this.state.shippingAddress.flat},</> : null}
                                                        ...
                                                        {this.state.shippingAddress.pincode}
                                                            ...
                                                            <td style={{ width: "30%" }}>
                                                                ...
                                                                {this.state.userDetails.phone}<br />
                                                        ...
                                                        {this.state.billingAddress.pincode}
                                                            ...
                                                            <td style={{ width: "40%" }}><br />
                                                                *Keep this Invoice and <br />manufacture box for<br />warranty purpose.
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <div class="mb-0">
                                                    <div class="row mt-4">
                                                        <div class="col-md-12">
                                                            <div class="table-responsive">
                                                                <table class="table table-bordered m-t-30 text-nowrap" style={{tableLayout: "fixed"}}>
                                                                    <thead>
                                                                        <tr>
                                                                    ...
                                                                    <tbody>
                                                                        {
                                                                            this.state.productDetail.map((obj, i) =>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        Product SKU Code : {obj.skuCode} <br />
                                                                            Product Code : {obj.productCode}<br />
                                                    ...
                                                    <div class="row">
                                                        <div class="" style={{ paddingRight: "20px", width: "100%" }}>
                                                            <table class="table m-t-30 text-nowrap">
                                                                <tbody>
                                                                    <tr>
                                                                        <td width="">
                                                                            <p class="mt-3 font-weight-600"><b style={{ fontSize: "large" }}>Total Qty : {this.state.bookingArray.totalQty} </b></p>
                                                                        </td>
                                                                        <td></td>
                                                                        <td>
                                                                            <p class="text-right mt-3 font-weight-600">Sub-total: ₹{parseInt(this.state.bookingArray.productSellingPrice)}</p>

                                                                            <h4 class="text-right text-xl">Grand Total : ₹{parseInt(this.state.bookingArray.productSellingPrice)}</h4>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        **Conditions Apply. Please refer to the product page for more details<br />
                                                                        E.&amp; O.E
                                                                    </td>
                                                                        ...
                                                                        <td class="text-right">
                                                                            ...
                                                                            <font size="2px" style={{ marginTop: "-5px" }}> Authorized Signature</font><br />
                                                                            <font size="4px">{this.state.bookingArray.vendorCompanyName}</font>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
