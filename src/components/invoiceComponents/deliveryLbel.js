...
export default class deliveryLbel extends Component {
    constructor(props) {
        // console.log('dasdsas')
        super(props)
                                    ...
                                    <div className="" style={{ padding: "5px", margin: "5px" }}>
                                        <div className="row" style={{ borderBottom: "solid 1px" }}>
                                            ...
                                            <div className="" style={{ borderLeft: "solid 1px", borderRight: "solid 1px", width: "75%", }}>
                                                <div style={{ padding: "0px 10px" }}>HCB Logistics</div>
                                                    ...
                                                    <div className="" style={{ borderRight: "solid 1px", fontSize: "11px", fontWeight: "800", width: "50%", padding: "5px 10px" }}>

                                                        {
                                                            this.state.bookingArray.paymentType == "cod" ?
                                                                <>COD : Rs. {(parseInt(this.state.bookingArray.productSellingPrice) + parseInt(this.state.bookingArray.productGST)) * parseInt(this.state.bookingArray.qty) + parseInt(this.state.bookingArray.deliveryCharge) - parseInt(this.state.bookingArray.couponDiscount) - parseInt(this.state.bookingArray.walletAmount) - parseInt(this.state.bookingArray.walletPoint)}/-</>
                                                                : <>PAID : Rs. {(parseInt(this.state.bookingArray.productSellingPrice) + parseInt(this.state.bookingArray.productGST)) * parseInt(this.state.bookingArray.qty) + parseInt(this.state.bookingArray.deliveryCharge) - parseInt(this.state.bookingArray.couponDiscount) - parseInt(this.state.bookingArray.walletAmount) - parseInt(this.state.bookingArray.walletPoint)}/-</>
                                                        }
                                                    </div>
                                        ...
                                        <div className="row" style={{ borderBottom: "solid 1px" }}>
                                            <div className="" style={{ borderRight: "solid 1px", padding: "14px", width: "50%" }}>
                                                <center>
                                                    <Barcode value={this.state.bookingArray.OrderID} id='divcontents' width='1' height='50' />
                                                    <br />
                                                    <br />
                                                </center>
                                            </div>
                                        ...
                                        <div className="row" >
                                            ...
                                            <div className="" style={{ padding: "15px", borderLeft: "solid 1px", width: "50%" }}>
                                                <center>
                                                    <QRCode
                                                        value={String(this.state.bookingDetails.OrderID)}
                                                        renderAs='svg'
                                                        includeMargin='true'
                                                    />
                                                    <br />
                                                    <span style={{ color: "black", fontWeight: 500 }}>{this.state.bookingArray.OrderID} </span>
                                                    <br />
                                        ...
                                        <div className="row" style={{ borderTop: "solid 1px", borderBottom: "solid 1px", fontSize: "14px" }}>
                                            ...
                                            <div style={{ textAlign: "center", borderLeft: "solid 1px", borderTop: "none", width: "30%", padding: "5px 0px" }}>Seller Name</div>
                                            <div style={{ textAlign: "center", borderLeft: "solid 1px", borderTop: "none", width: "25%", padding: "5px 0px" }}>GSTIN</div>
                                            ...
                                            <div align="center" style={{ height: "200px", textAlign: "center", borderLeft: "solid 1px", borderTop: "none", width: "30%", padding: "5px 0px" }}>{this.state.bookingArray.vendorCompanyName}</div>
                                            <div align="center" style={{ height: "200px", textAlign: "center", borderLeft: "solid 1px", borderTop: "none", width: "25%", padding: "5px 0px" }}>{this.state.vendorDetails.gst}</div>
                                            <div align="center" style={{ height: "200px", textAlign: "center", borderLeft: "solid 1px", borderTop: "none", width: "25%", padding: "5px 0px" }}>{this.state.bookingDetails.OrderID}</div>
                                            <div align="center" style={{ height: "200px", textAlign: "center", borderLeft: "solid 1px", width: "15%", padding: "5px 0px" }}>{this.state.bookingDetails.orderDate}</div>
                                        ...
                                        <div className="row">
                                            <div className="" style={{ borderBottom: "solid 1px", borderTop: "none", borderLeft: "none", width: "100%" }}>
                                                <div style={{ marginLeft: "10px", fontSize: "14px" }}>Order Through : <img style={{ height: "20px" }} src="http://admin.localhost:8000/logo/OHMAGO%20Delivery%20Services%20Logo%20PNG.png" /> <b style={{ fontSize: "12px" }}>HCB Enterprize</b></div>
                                            </div>
                                        </div>
                                        <div className="row">
