...
export class deliveryDetails extends Component {
   ...
   componentDidMount(){
    ...
    document.getElementById("global-loader").style.display = "block";
       ...
       get('/booking/deliveryboyReport/'+this.state.get_id)
       .then(res=>{
           ...
           this.setState({
                ...
                name:res.data[0].deliveryBoy.name
           })
       }).catch(err=>{
       ...
       return this.state.deliver_details.map((obj,i)=>{
           return(
            <tr key={i}>
                ...
                <td>{obj.bookingDetails.deliveryDate}</td>
            </tr>
        ...
        return (
            <div>
               <div className="page-header mt-0 p-3">
                    <h3 className="mb-0" style={{float: "left"}}>Delivery Boy Name : <b>{this.state.name}</b></h3>
                ...
                <div className="row">
                    <div className="col-xl-4 col-md-6">
                        <div className="card shadow text-center">
                            <div className="card-body">
                                <h3 className="mb-3">Order Assigned</h3>
                    ...
                    <div className="col-xl-4 col-md-6">
                        <div className="card shadow text-center">
                            <div className="card-body">
                                <h3 className="mb-3">Successfully Delivered</h3>
                    ...
                    <div className="col-xl-4 col-md-6">
                        <div className="card shadow text-center">
                            <div className="card-body">
                                <h3 className="mb-3">Pending Delivery</h3>
