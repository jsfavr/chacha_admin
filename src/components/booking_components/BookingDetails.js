...
export default class BookingDetails extends Component {
  ...
  getData = () => {
    ...
    let status = this.state.BookingStatus ? this.state.BookingStatus : 0;
    get("/booking/newBookingDetails/" + this.state.get_id + "/" + status)
      .then((res) => {
  ...
  openModel = (status) => {
    ...
    if (status == 2) {
      if (
        String(this.state.bookingArray.invoiceNumber).length > 2 &&
  ...
  render() {
    return (
      <div>
                ...
                <div className="clearfix">
                  <div className="float-left">
                    <h3 className="logo mb-0">
                      #Order ID-{this.state.bookingArray.orderID}
                    </h3>
                  </div>
                  <div className="float-right">
                    <h3 className="mb-0">
                      Date: {this.state.bookingArray.orderDate}
                    </h3>
                  </div>
                </div>
              </div>
                ...
                <div className="mb-0">
                    ...
                    <div className="col-md-12">
                      <div className="float-left">
                        ...
                        <address>
                          ...
                          {String(this.state.billingAddress.location).length >
                            2 && this.state.billingAddress.location != null ? (
                      ...
                      <div className="float-right text-right">
                        ...
                        <address>
                          ...
                          {String(this.state.shippingAddress.optionalPhone)
                            .length > 9 ? (
                            <>{this.state.shippingAddress.optionalPhone},</>
                          ) : null}
                          <br />
                          {this.state.shippingAddress.address},
                          {String(this.state.shippingAddress.flat).length > 2 &&
                          this.state.shippingAddress.flat != null ? (
                            <>{this.state.shippingAddress.flat},</>
                          ) : null}
                          {String(this.state.shippingAddress.landmark).length >
                            2 && this.state.shippingAddress.landmark != null ? (
                            <>{this.state.shippingAddress.landmark},</>
                          ) : null}
                          <br />
                          {String(this.state.shippingAddress.location).length >
                            2 && this.state.shippingAddress.location != null ? (
                          ...
                          <tbody>
                            {this.state.productDetail.map((obj, i) => (
                              <tr key={i}>
                                ...
                                <td>
                                  <a
                                    href={"/productDetails?id=" + obj.productID}
                                  >
                                    {obj.productName}
                                  </a>
                                  <br />
                                  <b>Size</b> : {obj.size}, <b>Color</b> :{" "}
                                  {obj.color}
                                </td>
                  ...
                  <div className="row">
                                  ...
                                  <a
                                    ...
                                    onClick={() =>
                                      this.handleInvoiceClick(
                                        this.state.bookingArray.orderStatus
                                      )
                                    }
                                    className="btn btn-primary btn-sm text-white"
                                  >
                                    Generate Invoice & Delivery Slip
                                  </a>
                                </>
                              ) : (
                                <>
                                  <span style={{ fontSize: "13px" }}>
                                    Invoice Number :{" "}
                                    <b>
                                      {this.state.bookingArray.invoiceNumber}
                                    </b>
                                  </span>
                                  <br />
                                  <Link
                        ...
                        this.state.bookingArray.orderStatus == 8 ? (
                          <tr>
                            ...
                            >
                              ...
                              <span style={{ fontSize: "13px" }}>
                                Delivery Boy Name :{" "}
                                {this.state.bookingArray.deliveryBoyName}
                              </span>
                              <br />
                              <span style={{ fontSize: "13px" }}>
                                Delivery Boy Phone No. :{" "}
                                {this.state.bookingArray.deliveryBoyPhone}
                              </span>
                              <br />
                              {this.state.bookingArray.orderStatus > 3 ? (
                                <span style={{ fontSize: "13px" }}>
                                  Delivery Date :{" "}
                                  {this.state.bookingArray.orderDate}
                                </span>
                              ) : null}
                            </td>
                          </tr>
                        ...
                        <tr>
                          ...
                          this.state.bookingArray.orderStatus == 8 ? (
                            <td colSpan="2" style={{ padding: "10px 15px" }}>
                              <b style={{ fontSize: "15px" }}>Return Details</b>
                              <br />
                              <span style={{ fontSize: "13px" }}>
                                Return Boy Name :{" "}
                                {this.state.bookingArray.returnBoyName}
                              </span>
                              <br />
                              <span style={{ fontSize: "13px" }}>
                                Return Boy Phone No. :{" "}
                                {this.state.bookingArray.returnBoyPhone}
                              </span>
                              <br />
                              {this.state.bookingArray.orderStatus == 8 ? (
                                <span style={{ fontSize: "13px" }}>
                                  Return Date :{" "}
                                  {this.state.bookingArray.returnDate}
                                </span>
                              ) : null}
                            </td>
                          ) : null}
                    ...
                    <div className="col-xl-4 col-4">
                      <p className="text-right mt-3 font-weight-600">
                        Sub-total: ₹
                        {parseInt(this.state.bookingArray.productSellingPrice)}
                      </p>
                      <p className="text-right mt-3 font-weight-600">
                        Coupon Discount: ₹
                        {parseInt(this.state.bookingArray.couponDiscount)}
                      </p>

                      <p className="text-right mt-3 font-weight-600">
                        Delivery Charge: ₹
                        {parseInt(this.state.bookingArray.deliveryCharge)}
                      </p>
                      ...
                      <h4 className="text-right text-xl">
                        ...
                        {parseInt(this.state.bookingArray.productSellingPrice) +
                          parseInt(this.state.bookingArray.deliveryCharge) -
                          parseInt(this.state.bookingArray.couponDiscount) -
                          parseInt(this.state.bookingArray.walletAmount) -
                          parseInt(this.state.bookingArray.walletPoint)}
                      </h4>
                      {/* 
                      ...
                      {this.state.bookingArray.paymentType ==
                      "wallet" ? null : ( // <h5 className="text-right text-xl" style={{ marginBottom: 0 }}><span className="badge badge-default">{ this.state.bookingArray.paymentType}</span></h5>
                        <>
                          <h5
                          ...
                          <h5 className="text-right">
                            ...
                            >
                              Transaction ID -{" "}
                              {this.state.bookingArray.razorpayPaymentId}
                            </span>
                          </h5>
                        </>
                      )}
              ...
              <div className="col-md-6">
                <div class="form-group">
                  ...
                  <input
                    ...
                    style={{ border: "1px solid rgb(0 0 0 / 34%) !important" }}
                  />
                </div>
              </div>
              <div className="col-md-6">
        ...
        <Modal
          open={this.state.reasonModalStatus}
