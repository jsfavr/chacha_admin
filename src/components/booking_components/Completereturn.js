...
export default class Completereturn extends Component {
    ...
    bookingShow = () => {
        return this.state.bookings.map((obj, i) => {
            if (obj.bookingDetails.orderStatus == 8) {
                return (
                    <tr className="odd" key={i}>
                        ...
                        <td>
                            <Link to={"/Viewbooking?booking_id=" + obj.bookingDetails.OrderID + "&status=5"} className="btn btn-icon btn-sm btn-primary mt-1 mb-1" type="button">
        ...
        return (
            <div>
                <div className="page-header mt-0 p-3">
                    <h3 className="mb-sm-0">Complete Return Booking</h3>
